...
struct max_heap * create_heap(struct max_heap * heap);
void down_heapify(struct max_heap * heap, int index);
void up_heapify(struct max_heap * heap, int index);
void push(struct max_heap * heap, int x);
void pop(struct max_heap * heap);
int top(struct max_heap * heap);
int empty(struct max_heap * heap);
int size(struct max_heap * heap);

int main() {
    struct max_heap * head = create_heap(head);
    push(head, 10);
